...
echo "Starting Test" && \
    ...
    $python_exe $dice_distro_file $test_params -d 6 -n 2 --op-func bit-or && \
    $python_exe $dice_distro_file $test_params -d 6 -n 2 --op-func bit-xor && \
    $python_exe $dice_distro_file $test_params -d 6 -n 2 --op-func bit-and && \
    ...
    $python_exe $dice_distro_file $test_params -d 6 -n 1 --op-func shift --op-params 2 && \
    $python_exe $dice_distro_file $test_params -d 6 -n 2 --op-func shift --op-params 2 -1 && \
    $python_exe $dice_distro_file $test_params -d 6 -n 1 --op-func scale --op-params r-ceil 0.5 && \
    $python_exe $dice_distro_file $test_params -d 6 -n 1 --op-func scale --op-params r-floor 0.5 && \
    $python_exe $dice_distro_file $test_params -d 6 -n 1 --op-func scale --op-params r-truncate 0.5 && \
    $python_exe $dice_distro_file $test_params -d 6 -n 1 --op-func scale --op-params r-half-up 0.5 && \
    $python_exe $dice_distro_file $test_params -d 6 -n 1 --op-func scale --op-params r-half-down 0.5 && \
    $python_exe $dice_distro_file $test_params -d 6 -n 2 --op-func scale --op-params 0.5 0.333 prod && \
    $python_exe $dice_distro_file $test_params -d 6 -n 1 --op-func bound --op-params 3 4 && \
    $python_exe $dice_distro_file $test_params -d 6 -n 2 --op-func bound --op-params 2 5 3 4 && \
    $python_exe $dice_distro_file $test_params -d 6 -n 1 --op-func shift --op-params 2 bound 1 6 && \
    ...
    $python_exe $dice_distro_file $test_params -d 6 -n 2 --op-func reroll-if --op-params lt 4 && \
    $python_exe $dice_distro_file $test_params -d 6 -n 4 --op-func sum --op-params 2 reroll-if lt 7 && \
    $python_exe $dice_distro_file $test_params -d 6 -n 4 --op-func slice-apply --op-params 2 sum max && \
    $python_exe $dice_distro_file $test_params -d 6 -n 4 --op-func reroll-if --op-params mod 2 eq 1 && \
    ...
    $python_exe $dice_distro_file $test_params --multi-die-sides 8 6 4 --op-func reroll-if --op-params lt 3 && \
    $python_exe $dice_distro_file $test_params --multi-die-sides 8 6 4 --op-func reroll-if --op-params lt 5 4 && \
